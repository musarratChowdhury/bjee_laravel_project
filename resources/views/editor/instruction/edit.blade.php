...
@section('title-tag', 'Edit Instruction | ')
      ...
      <div class="col-lg-12">
        <div class="card">
          ...
          <div class="card-body card-block">
            ...
            <form action="{{ route('editor.update-instruction',$data->id) }}" method="post">
              {{csrf_field()}}
              @method('PUT')
              <div class="row">
                <div class="col-lg-8">
                  <div class="has-success form-group">
                    ...
                    <input type="text" id="instruction" class="form-control-success form-control @error('name') is-invalid @enderror" name="instruction" value="{{$data->instructions}}" required>
                  ...
                  <div class="has-success form-group">
                    ...
                    <input type="text"  class="form-control-success form-control @error('name') is-invalid @enderror" name="serial_number" value="{{$data->serial_number}}" required>
