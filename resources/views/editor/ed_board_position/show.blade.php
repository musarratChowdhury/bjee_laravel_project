...
@section('title-tag', 'Editorial Positions ')
      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-header">
            <strong>Editorial Position Details</strong>
          </div>


          <div class="card-body card-block">
          <ul class="list-group">
           <li class="list-group-item">Position Name : {{$position->POSITION_NAME}}</li>
           <li class="list-group-item">Hierarchy No : {{$position->HIERARCHY_NO}}</li>
